...
class MotorsDirectionRequest(BaseModel):
    motor_mask: Optional[int] = Field(None, description="Маска моторов (1 - левый, 2 - правый, 3 - оба)")
    direction_left: Optional[int] = Field(
        None, description="Направление левого мотора (1 - вперед, -1 - назад, 0 - стоп)")
    direction_right: Optional[int] = Field(
        None, description="Направление правого мотора (1 - вперед, -1 - назад, 0 - стоп)")
